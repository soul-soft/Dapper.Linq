        ...
        private static DbTable MapperCache(Type type)
        {
            if (!CacheTables.ContainsKey(type))
            {
                ...
                foreach (var property in properties)
                {
                    ...
                    var propertyName = attribute == null ? property.Name : attribute.ColumnName;
                    var primaryKey = !table.Columns.Exists(e => e.PrimaryKey) && attribute != null && attribute.PrimaryKey ? true : false;
                ...
                if (!table.Columns.Exists(e=>e.PrimaryKey))
                {
                    table.Columns.First().PrimaryKey = true;
                }
                #endregion
